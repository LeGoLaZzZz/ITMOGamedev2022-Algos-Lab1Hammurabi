...
class BeautyGameLogger : public IGameLogger
{
public:
    ...
    std::string GetStatusCitizenWheatConsumption(City& city, int wheatConsumed, int deadPercentage,
        int deadCitizen) override;
    ...
    std::string GetGameLoseText(City& city, RoundResultEnum round_result_enum) override;
    std::string AskLoadSave() override;
};
